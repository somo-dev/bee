          ...
          {leftSection && (
            <div className={cn(leftSectionStyles, sizeStyles.icon)}>
              {React.isValidElement(leftSection)
                ? React.cloneElement(leftSection as any, {
                    className: cn(sizeStyles.icon, (leftSection as any).props.className),
                  })
                : leftSection}
            </div>
          )}
            ...
            {rightSection && (
              <div className={sizeStyles.icon}>
                {React.isValidElement(rightSection)
                  ? React.cloneElement(rightSection as any, {
                      className: cn(
                        sizeStyles.icon,
                        (rightSection as any).props.className
                      ),
                    })
                  : rightSection}
              </div>
