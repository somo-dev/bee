        ...
        <div className="max-w-7xl mx-auto px-6 py-20 sm:py-32 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-12 leading-relaxed">
              BUI is a modern, accessible, and customizable React component
              library. Build production-ready applications with our
              comprehensive collection of beautifully designed components.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Built with modern web standards and designed for developer
              experience
            </p>
          </div>
