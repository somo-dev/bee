...
const components = [
  ...
  },
  {
    name: "ColorPicker",
    description:
      "Advanced color picker with predefined colors, custom picker, and flexible configuration options.",
    icon: Palette,
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-6 gap-2">
          {[
            ...
            <div
              key={color}
              className="w-8 h-8 rounded border-2 border-gray-200 hover:scale-110 transition-transform cursor-pointer"
              style={{ backgroundColor: color }}
            />
          ))}
        </div>
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-blue-600 rounded border border-gray-300" />
          <span className="text-xs font-mono text-gray-600">#3B82F6</span>
        </div>
      </div>
    ),
  },
  {
    ...
    description:
      "Scroll-controlled navigation component with auto-detection, smooth scrolling, and nested structure support.",
    icon: List,
    ...
    content: (
      <div className="space-y-2">
        <div className="flex items-center gap-2 p-2 bg-blue-900 text-white rounded text-xs">
          <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
          <span>Usage</span>
        </div>
        <div className="flex items-center gap-2 p-2 text-gray-300 rounded text-xs">
  ...
  },
  {
    name: "Toaster",
    description:
      "Beautiful toast notifications with stacking, positioning, and advanced UX features.",
    icon: Bell,
    href: "/components/toaster",
    color: "from-orange-500 to-orange-600",
    features: ["6 Positions", "Auto-dismiss", "Progress Bar", "Action Buttons"],
    status: "Stable",
    content: (
      <div className="space-y-3">
        <div className="flex items-center gap-2 p-2 bg-blue-50 border border-blue-200 rounded text-xs">
          <Info className="w-3 h-3 text-blue-600" />
          <span className="text-blue-900">Info notification</span>
        </div>
        <div className="flex items-center gap-2 p-2 bg-green-50 border border-green-200 rounded text-xs">
          <CheckCircle className="w-3 h-3 text-green-600" />
          <span className="text-green-900">Success message</span>
        </div>
