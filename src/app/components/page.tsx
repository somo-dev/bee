...
const components = [
  {
    name: 'Button',
    description: 'Interactive button component with multiple variants, sizes, loading states, and icon support.',
    icon: MousePointer,
  ...
  {
    name: 'Breadcrumbs',
    description: 'Navigation breadcrumb component with customizable separators, icons, and collapsible items.',
    icon: Navigation,
    href: '/components/breadcrumbs',
    color: 'from-green-500 to-green-600',
    features: ['4 Variants', 'Custom Separators', 'Icon Support', 'Collapsible'],
    status: 'Stable'
  },
  {
    name: 'Pagination',
    description: 'Advanced pagination component with jump-to-page functionality and responsive design.',
    icon: ChevronRight,
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {components.map((component) => {
            ...
            return (
              ...
              >
                {/* Component Header */}
                <div className={`h-40 bg-gradient-to-br ${component.color} flex items-center justify-center relative`}>
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-2xl font-semibold text-gray-900">{component.name}</h3>
                  </div>
        ...
        <div className="mt-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">More Components Coming Soon</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We're actively working on expanding our component library. Stay tuned for more exciting components!
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl border-2 border-dashed border-gray-200 p-12">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Under Development</h3>
